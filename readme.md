...
|----------------------------------------------------|---------------|---------|----------------------------------------------------------------------------------------------------|
| ERROR_HANDLER_DEV_MODE                             | 0             | 1       | print out important debugging information and stop the execution (comfortable development)         |
| ERROR_HANDLER_MAX_DUMP_LEVEL                       | 5             | 3       | the nesting level of the objects to be serialized (3 is less detailed level than 5)                |
| ERROR_HANDLER_IGNORE_RECORD_LEVEL_BELOW            | 0             | 250     | errors with a level below the specified one will be ignored (250 is NOTICE)                        |
